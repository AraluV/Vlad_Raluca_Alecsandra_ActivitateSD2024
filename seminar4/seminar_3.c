...
struct Masina* citireFisier(const char* numeFisier, int* nrMasini) { //nr de masini alocat prin pointer
...
int main(void)
{
    ...
    int nrLinii = 3;
    int* nrCol;
    nrCol = (int*)malloc(sizeof(int) * nrLinii); // alocare spatiu pt vectorul de lungimi
